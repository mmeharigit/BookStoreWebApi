    ...
    public partial class BookStoresDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Author>(entity =>
            {
                ...
                entity.Property(e => e.LastBook)
                    .HasColumnName("last_book")
                    .HasMaxLength(100)
                    .IsUnicode(false);
            ...
            modelBuilder.Entity<Book>(entity =>
            {
                ...
                entity.HasOne(d => d.Pub)
                    ...
                    .HasConstraintName("FK__Book__pub_id__1BFD2C07");
            });
            ...
            modelBuilder.Entity<BookAuthor>(entity =>
            {
                ...
                entity.HasOne(d => d.Author)
                    ...
                    .HasConstraintName("FK__BookAutho__autho__1CF15040");

                entity.HasOne(d => d.Book)
                    .WithMany(p => p.BookAuthors)
                    .HasForeignKey(d => d.BookId)
                    .HasConstraintName("FK__BookAutho__book___1DE57479");
            });
            ...
            modelBuilder.Entity<Publisher>(entity =>
            {
                entity.HasKey(e => e.PubId)
                    .HasName("PK__Publishe__2515F2220CBAE877");
            ...
            modelBuilder.Entity<Sale>(entity =>
            {
                ...
                entity.HasOne(d => d.Book)
                    .WithMany(p => p.Sales)
                    .HasForeignKey(d => d.BookId)
                    .HasConstraintName("FK__Sale__book_id__1ED998B2");

                entity.HasOne(d => d.Store)
                    .WithMany(p => p.Sales)
                    .HasForeignKey(d => d.StoreId)
                    .HasConstraintName("FK__Sale__store_id__1FCDBCEB");
            });
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.HasOne(d => d.Job)
                    ...
                    .HasConstraintName("FK__User__job_id__20C1E124");

                entity.HasOne(d => d.Pub)
                    .WithMany(p => p.Users)
                    .HasForeignKey(d => d.PubId)
                    .HasConstraintName("FK__User__pub_id__21B6055D");
            });
